...
messages in strings and byte buffers
Understanding the Server:
1. Explain the argument that the 'run_acceptor' thread is passed as an argument.
2. How are received messages stored?
stored in te linked list
3. What does 'main()' do with the received messages?
Stops acceptor thread and collects all messages from the list
4. How are threads used in this sample code?j
...
Prevents threads from getting stuck waiting
*/
#include <arpa/inet.h>
#include <errno.h>
#include <fcntl.h>
